...
function buildSeedPrompt(params: {
  ...
  const parts = [
    ...
    '',
    `4. **Create GitHub Issue** in \`samgibson-bot/gold-ideas\` with the full research summary. Use a descriptive title${title ? ` (suggested: "${title}")` : ''}. Include source link, integration pathways, and synergy analysis.`,
    '',
